...
const HINTS = {
  ...
  bias: "Average projection minus actual result. Positive means projections were too high overall; negative means too low.",
  "rank correlation": "How well the projected order matched the actual scoring order. Higher is better; it can be good even when point totals miss.",
  "median abs error": "The middle absolute miss after sorting all misses. It describes the typical miss and is less affected by one extreme game than MAE.",
  "median absolute error": "The middle absolute miss after sorting all misses. It describes the typical miss and is less affected by one extreme game than MAE.",
  "over rate": "The share of matched games where projection was higher than the actual score.",
  "under rate": "The share of matched games where projection was lower than the actual score.",
  "within 5": "The share of matched games where projection finished within five fantasy points of the actual result.",
  "top n precision": "Among projected top-tier players at each position, the share that also finished inside that actual top tier. Hidden until enough players are graded.",
  "p10 p90 coverage": "The share of actual scores that landed inside the model's 10th-to-90th percentile range. Around 80% would be ideal for a calibrated range.",
  "position level mae": "Mean Absolute Error calculated separately by position, so QB, RB, WR, TE, and K misses do not hide each other.",
  "arsenal edge": "On players both sources projected, how often Arsenal had the smaller absolute miss.",

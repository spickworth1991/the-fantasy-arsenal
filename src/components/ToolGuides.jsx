...
const GUIDES = {
  ...
  "/stat-central": [
    ...
    s('[data-guide-tip="matchup-secondary-tabs"] button:nth-of-type(2)', "Team Profiles", "All, QB, RB, WR, and TE sections remain visible together. This view only needs season and scoring, so matchup-only team and position controls disappear. Choose League scoring to reveal the Sleeper league picker; changing that league rebuilds every profile with its exact scoring rules.", tab("Team Profiles")),

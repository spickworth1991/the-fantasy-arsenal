...
const GUIDES = {
  ...
  "/player-availability": [
    ...
    s('[data-guide-tip="availability-scan"]', "Choose the portfolio leagues", "Scanned is every league successfully read. Included is the exact set used by availability results after your league filters and selections."),
    s('[data-guide-tip="availability-settings"]', "One place controls league scope and ranking", "Open this group for the single Included leagues selector, projection or value source, weekly or season horizon, scoring and quarterback assumptions, Best Ball scope, drafting leagues, position, sorting, minimum availability, and result limit. Weekly projections are the recommended waiver lens; season projections and values provide longer-term context."),
    ...
    s('[data-guide-tip="availability-check-controls"]', "Refresh or refine the results", "Player checks rebuild automatically. Refresh rosters when a draft, waiver run, trade, or free-agent move may have changed Sleeper ownership; Filters and Included control which leagues are considered."),

...
export default function TradeWorkspaceSuite({
  ...
  return <Panel className="mb-6 overflow-hidden border-violet-300/15">
    ...
    <div className="p-3 sm:p-4">
      {handoffContext?.surplus || handoffContext?.need ? <div className="mb-3 rounded-2xl border border-amber-300/15 bg-amber-300/[0.055] p-3 text-xs text-amber-100/75"><b>Intelligence handoff:</b> find partners who can use {handoffContext.surplus || "your surplus"} depth and can return {handoffContext.need || "a position of need"}. The finder below is loaded for this league and ranks mutually useful packages.</div> : null}

...
function MyTeamView({ name, roster, draftedIds, needs, recommendations, candidates, players }) {
...
export default function DraftHelperClient() {
  ...
  return <main className="min-h-screen text-white"><BackgroundParticles /><Navbar pageTitle="Draft Command Center" /><div className="mx-auto max-w-[1500px] px-4 pb-20 pt-20">
    ...
    {draft ? <>
      ...
      {tab === "needs" ? <TeamNeedsView rosters={rosters} rosterMap={rosterMap} userMap={userMap} players={players} league={league} draftedByRoster={draftedByRoster} ranked={ranked} onRecommend={(rosterId)=>{setFocusRosterId(String(rosterId));setTab("room");}} /> : null}

...
function makeGetPlayerValue(valueSource, format, qbType, scoring = "ppr") {
  return (p) => {
    ...
    if (valueSource === "FantasyCalc") {
      ...
      const profile=["std","half","ppr","std-tep","half-tep","ppr-tep","std-tep-plus","half-tep-plus","ppr-tep-plus"].includes(scoring)?scoring:"ppr";
    ...
    if (valueSource === "FantasyPros") {
      ...
      if (String(scoring).toLowerCase() === "tep") return qbType === "sf" ? (p.fp_values?.dynasty_sf_tep || p.fp_values?.dynasty_sf || 0) : (p.fp_values?.dynasty_1qb_tep || p.fp_values?.dynasty_1qb || 0);
    ...
    if (valueSource === "IDynastyP") {
      if (String(scoring).toLowerCase() === "tep") return qbType === "sf" ? (p.idp_values?.superflex_tep || p.idp_values?.superflex || 0) : (p.idp_values?.one_qb_tep || p.idp_values?.one_qb || 0);

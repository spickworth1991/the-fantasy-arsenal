...
export default function DraftGradesClient() {
  ...
  return <main className="min-h-screen overflow-x-hidden text-white [&_button]:min-w-0 [&_section]:min-w-0"><BackgroundParticles/><Navbar pageTitle="Draft Grade Studio"/><div className="mx-auto min-w-0 max-w-7xl px-3 pb-20 pt-20 sm:px-4">

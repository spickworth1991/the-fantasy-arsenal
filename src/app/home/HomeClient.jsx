...
function Badge({ text }) {
  ...
  return (
    <span
      className={`absolute top-2 right-2 px-2 py-1 rounded text-xs font-bold tracking-wide ${cls}`}
    >
      {key}
    </span>
  );
  ...
  const tools = [
    {
      ...
      link: "/trade",
      description:
        "Analyze trades using multiple value sources. Select a league for personalized trades.",
      // badge: "UPDATED",
    },
    {
      name: "Player Stock",
